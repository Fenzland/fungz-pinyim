...
|  部位＼方式	 | 收爆音(濁)  | 爆音(清)     | 爆吹音(清)   | 漏爆音(濁)  | 鼻音(濁)    | 收擦音(濁)  | 吹擦音(清)  | 收塞擦音(濁) |  塞擦音(清)   | 塞吹擦音(清)  |
|------------|------------|-------------|-------------|------------|------------|------------|------------|-------------|-------------|--------------|
|  脣/脣-齒	 | B /b/      | b /p/       | p /pʰ/      |            | m /m/      | v /v/      | f /f/      | Ɓ /bv/ (Bv) | ɓ /pf/ (bf) | ƥ /pfʰ/ (pf) |
|  舌尖-齒	 | D /d/      | d /t/       | t /tʰ/      | l /l/      | n /n/      | r /z/      | s /s/      | Z /dz/      | z /ts/      | c /tsʰ/      |
|  舌尖-顎	 | Ď /ɖ/ (Dh) | ď /ʈ/ (dh)  | ť /ʈʰ/ (th) | ľ /ɭ/ (lh) | ň /ɳ/ (nh) | ř /ʐ/ (rh) | š /ʂ/ (sh) | Ž /ɖʐ/ (Zh) | ž /ʈʂ/ (zh) | č /ʈʂʰ/ (ch) |
|  舌面-顎	 |            |             |             |            | ñ /ɲ/ (y)  | X /ʑ/      | x /ɕ/      | J /d̠ʑ/      | j /t̠ɕ/      | q /t̠ɕʰ/      |
|  舌根  	 | G /g/      | g /k/       | k /kʰ/      |            | ŋ /ŋ/ (ng) | H /ɣ/      | h /x/      |             |             |              |
...
* **收爆音**
	發音部位封閉氣流，聲帶發聲，並爆破，爆破時收住氣流，爆破後不吹氣。爆破時無力量，靠聲帶發音，爲濁音。普通話中無此種音，例音有英語中的 **b**uy **d**ie **g**uy 等。
* **爆音**
